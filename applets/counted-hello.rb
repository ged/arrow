...
### A modified version of the 'Hello World' applet to illustrate how applet
### chaining works.
class CountedHello < Arrow::Applet
	...
	Signature = {
		...
		:description => %{A modified 'hello world' applet to } +
			%{illustrate how applet-chaining works.},
		:uri => "counter/hello",

...
- RSpec (>= 1.0.3) — This is required to run the test suite
- Rcov (>= 0.8.1.2.0) — Used to check test coverage

h4. Documentation Tasks

- Rote (>= 0.3.4) — Used to generate the user manual.
- Darkfish RDoc — An alternate template for RDoc

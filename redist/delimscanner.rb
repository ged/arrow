...
# == Version
#
#  $Id: delimscanner.rb,v 1.1 2003/08/05 19:45:46 deveiant Exp $
# 
...
class DelimScanner
	...
	extend Forwardable, CrossCase
	StringScanner.must_C_version


	### Class constants
	Version = /([\d\.]+)/.match( %q{$Revision: 1.1 $} )[1]
	Rcsid = %q$Id: delimscanner.rb,v 1.1 2003/08/05 19:45:46 deveiant Exp $
